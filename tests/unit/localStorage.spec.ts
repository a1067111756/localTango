...
describe('插件 -> 功能API测试 -> localStorage', () => {
  ...
  it('setItem / getItem测试', async () => {
    ...
    (LocalTango.storage as any).setItem(key1, value1)
    expect((LocalTango.storage as any).getItem(key1)).toEqual(value1)
  ...
  it('setItemString / getItemString测试', async () => {
    ...
    (LocalTango.storage as any).setItemString(key1, value1)
    expect((LocalTango.storage as any).getItemString(key1)).toEqual(value1)
  ...
  it('setItemNumber / getItemNumber测试', async () => {
    ...
    const value1 = 11;
    (LocalTango.storage as any).setItemNumber(key1, value1)
    expect((LocalTango.storage as any).getItemNumber(key1)).toEqual(value1)
  ...
  it('setItemBoolean / getItemBoolean测试', async () => {
    ...
    const value1 = false;
    (LocalTango.storage as any).setItemBoolean(key1, value1)
    expect((LocalTango.storage as any).getItemBoolean(key1)).toBeFalsy()
  ...
  it('setItemJSON / getItemJSON测试', async () => {
    ...
    (LocalTango.storage as any).setItemJSON(key1, value1)
    expect((LocalTango.storage as any).getItemJSON(key1)).toEqual(value1)
  ...
  it('getItemExpired / setItemExpired测试', async () => {
    ...
    (LocalTango.storage as any).setItemExpired(key1, value1, 10 * 1000)
    expect((LocalTango.storage as any).getItemExpired(key1)).toEqual(value1)
